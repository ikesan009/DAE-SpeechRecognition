...
class MyDataset():
    ...
    def __getitem__(self, idx):
        video_file = os.path.splitext(self.video_path+self.list[idx][0])[0]+'.npy'
        video_inputs = load_video_file(video_file[:len(self.video_path)]+video_file[len(self.video_path)+len(self.video_path):])
